...
User.create!(first_name:"Linda", last_name:"Tang", email: "test1@test.com", password: "password", date_of_birth: "04/01/1992", state: "NY", city:"Brooklyn")
User.create!(first_name:"Stephanie", last_name:"Lopez", email: "test2@test.com", password: "password", date_of_birth: "10/19/1987", state: "IL", city:"Cicero")
User.create!(first_name:"Gloria", last_name:"Adams", email: "test3@test.com", password: "password", date_of_birth: "03/16/1994", state: "FL", city:"Miami")
User.create!(first_name:"Cassandra", last_name:"Bucio", email: "test4@test.com", password: "password", date_of_birth: "01/12/1988", state: "FL", city:"Miami")
User.create!(first_name:"Andrea", last_name:"Ortiz", email: "test5@test.com", password: "password", date_of_birth: "05/08/1998", state: "IL", city:"Chicago")
